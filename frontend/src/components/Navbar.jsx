...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      <Link to='/'><img src={assets.logo_png} className='w-36' alt="logo" /></Link>
      ...
      <div className='flex items-center gap6' >
        ...
        <div className='group relative'>
          {/* <Link to='/login'> */}
          <img onClick={() => token ? null : navigate('/login') } src={assets.profile_icon} className='text-gray-700 w-5 cursor-pointer ml-2.5' alt="Profile" />
          {/* </Link> */}
        ...
        <img src={assets.cart_icon} className='text-gray-700 w-5 cursor-pointer ml-2.5' alt="cart" />
        ...
        <img onClick={()=> setVisible(true)} src={assets.menu_icon} className='text-gray-700 w-5 cursor-pointer sm:hidden ml-2.5' alt="menubar" />
